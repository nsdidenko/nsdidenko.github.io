...
You are responsible for taking all reasonable steps to ensure that no unauthorized person shall have access to your App passwords or account. It is your sole responsibility to (1) control the dissemination and use of sign-in name, screen name and passwords; (2) authorize, monitory, and control access to and use of your App account and password; (3) promptly inform the Company if you believe your account or password has been compromised or if there is any other reason you need to deactivate a password. Send us an email at barsiksoft@gmail.com. You grant the Company and all other persons or entities involved in the operation of the App the right to transmit, monitor, retrieve, store, and use your information in connection with the operation of the App. The Company cannot and does not assume any responsibility or liability for any information you submit, or your or third parties’ use or misuse of information transmitted or received using the App.
...
If you have any comments or questions on any part of the services or any part of this Terms of Service, please feel free to contact us at barsiksoft@gmail.com.